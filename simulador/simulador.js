function iniciarSimulador() {
  ...
  function centrarDiseno() {
    if (window.innerWidth <= 640) {
      previewDiseno.style.left = "91px";
      previewDiseno.style.top = "86px";
  ...
  function centrarTexto() {
    if (window.innerWidth <= 640) {
      previewTexto.style.left = "63px";
      previewTexto.style.top = "186px";
      previewTexto.style.width = "145px";
    } else if (window.innerWidth <= 900) {
  ...
  function manejarSubidaImagen(e) {
    ...
    previewDiseno.src = objectUrlActual;
  ...
  textoInput.addEventListener("input", manejarTexto);
  tamanoInput.addEventListener("input", manejarTamanoDiseno);
  textoTamanoInput.addEventListener("input", manejarTamanoTexto);
  colorTextoInput.addEventListener("input", manejarColorTexto);
  tipografiaInput.addEventListener("change", manejarFuenteTexto);
  ...
  limpiarBtn.addEventListener("click", limpiarSimulador);
